...
import whiteLogo from '../../assets/rookWhite.svg';
import blackLogo from '../../assets/rookBlack.svg';
import { Colors } from "../Board";
import { Cell } from "../Cell";

export class Rook extends Figure {
    constructor(color: Colors, cell: Cell) {
        super (FigureNames.ROOK, color, cell, color === Colors.WHITE ? whiteLogo : blackLogo)
    }
